...
<div class="container py-4">
  <div class="card shadow-sm mb-4">
    <div class="card-body">
      ...
      <!-- Search form (GET) -->
      <form class="row g-2 mb-3" method="get" action="<?= site_url('sekolah') ?>">
        <div class="col-md-4">
        ...
        <?php if (! empty($q)): ?>
        <div class="col-auto">
          <a href="<?= site_url('sekolah') ?>" class="btn btn-outline-secondary">Reset</a>
        </div>
        <?php endif; ?>
      </form>
        ...
        <table class="table table-hover align-middle mb-0">
          <thead class="table-light">
            <tr>
              ...
              <th>
                <a href="<?= esc($build_sort_url('nama_sekolah')) ?>" class="text-decoration-none text-dark">
                  Nama Sekolah
            ...
            <?php if (! empty($sekolah)): ?>
              ...
              <?php foreach ($sekolah as $s): ?>
                <tr>
                  ...
                  <td>
                    <a href="<?= site_url('sekolah/show/'.$s['id_sekolah']) ?>" class="btn btn-sm btn-outline-primary me-1">
                      <i class="bi bi-eye"></i> Detail
                    </a>
                    <a href="<?= site_url('sekolah/edit/'.$s['id_sekolah']) ?>" class="btn btn-sm btn-primary me-1">
